    ...
    switch(this.props.company) {
      case companies.FASTIT:
        return <Form>
          ...
          <Segment vertical>
            <Header as="h3">Quelle est votre appréciation sur la qualité de l'accompagnement de Fast IT ?</Header>
          ...
          <Segment vertical>
            <Header as="h3">Quelle est votre appréciation sur la vitesse d'avancement de l'équipe Fast IT?</Header>
          ...
          <Segment vertical>
            <Header as="h3">Si vous aviez une baguette magique, quelle est "la" chose que vous changeriez chez Fast IT ?</Header>
            { this.props.form['magic-wand'].split(/\n/).map((string, index) => <p key={`magix-wand-${index}`}>{ string }</p>) }
          </Segment>
          <Segment vertical>
            <Header as="h3">Seriez-vous prêt à recommander Fast IT ?</Header>
          ...
          <Segment vertical>
            <Header as="h3">Souhaitez-vous rencontrer un chef de projet Fast IT dans la semaine à venir pour échanger sur le déroulement du projet ?</Header>
