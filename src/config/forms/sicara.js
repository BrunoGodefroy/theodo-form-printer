  ...
  questions: [
    {
      ...
      label: 'Quelle est votre appréciation sur la vitesse d\'avancement de l\'équipe Sicara ?',
    ...
    },
    {
      ...
      label: 'Quelle est votre appréciation sur la qualité de l\'accompagnement Sicara ? ',
      type: types.MULTIPLE_CHOICE,
      choices: [
        {
          slug: 5,
    ...
    },
    {
      ...
      label: 'Souhaitez-vous faire un point commercial avec Sicara dans la semaine à venir ?',
      type: types.MULTIPLE_CHOICE,
      choices: [
        {
          slug: 'yes',
